...
// #define limitSwitch1 22
// #define limitSwitch2 23
// #define limitSwitch3 24
...
const float theta1AngleToSteps = 13.444444;
const float theta2AngleToSteps = 7.555555;
const float phiAngleToSteps = 22;
const float zDistanceToSteps = 210;
...
void loop() {
  ...
  if (data[1] == 1) {
    stepper1.setSpeed(data[6]);
    stepper2.setSpeed(data[6]);
    stepper3.setSpeed(data[6]);
    stepper4.setSpeed(data[6]);
    stepper1.setAcceleration(data[7]);
    stepper2.setAcceleration(data[7]);
    stepper3.setAcceleration(data[7]);
    stepper4.setAcceleration(data[7]);
...
//     stepper1.runSpeed();
//     stepper1.setCurrentPosition(-1350); // When limit switch pressed set position to 0 steps
//   }
//   delay(20);
//   stepper1.moveTo(0);
